...
```
  ...
  $$(actual\_length) = 1.4164 +  1.2235*(estimated\_length)$$
  
  
      For 1 day of increase in the ``estimated_length``, the ``actual_length`` increases by 1.2235 days, which effectively means that the company underestimates the job lengths.
