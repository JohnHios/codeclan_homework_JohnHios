...
**Ans 4.**  
```{r}
pattern <- "[A-Z][a-z]+ [0-9]+[a-z]{2}, [0-9]{4}"
...
**Ans 6.**  
```{r}
# find all possible occurrences of 'gin' in the text
pattern <- "[ ,\\.-][gG][iI][nN][ ,\\.-]"
...
```{r}
# Run a check to confirm that nothing has been missed out
pattern <- "[ ,\\.-][gG][iI][nN][ ,\\.-]"
...
whole_text %>%
  ...
  str_replace_all(c("Ministry" = "Department", "Ministrie" = "Department")) %>%
