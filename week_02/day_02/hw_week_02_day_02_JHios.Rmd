...
**Ans 4.**  
```{r}
pattern <- "[A-Z]{1}[a-z]+ [0-9]+[a-z]{2}, [0-9]{4}"
...
```{r}
whole_text %>% 
  str_replace_all(c("Victory Gin" = "Victory Vodka", "VICTORY GIN" = "VICTORY VODKA", "victory gin" = "victory vodka", " gin" = " vodka"))
```
...
**Ans 7.**  
```{r}
# exploration of effectiveness of my proposed pattern
whole_text %>% 
...
# my clunky version
whole_text %>% 
  str_replace_all(c("Department" = "Section", "department" = "section")) %>% 
  str_replace_all(c("Ministry" = "Department", "Ministries" = "Departments", "ministry" = "department", "ministries" = "departments")) %>% 
  str_replace_all(c("Mini" = "Dep"))
